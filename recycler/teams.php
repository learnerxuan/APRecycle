...
$sql = "SELECT u.team_id, t.team_name, t.description,
        (SELECT COALESCE(SUM(lifetime_points), 0) FROM user WHERE team_id = t.team_id) as points
        FROM user u 
    ...
    <div class="container" style="padding-top: 2rem;">
        <?php if ($has_team): ?>
            <div class="page-hero">
                ...
                <div
                    style="margin-top: 1.5rem; display: inline-block; background: rgba(255,255,255,0.2); padding: 8px 16px; border-radius: 20px; font-weight: bold;">
                ...
                <?php while ($mem = $members->fetch_assoc()): ?>
                    <div class="member-item">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div
                                style="width: 35px; height: 35px; background: #edf2f7; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                👤</div>
            ...
            <div class="split-container">
                <div class="split-box">
                    <div>
                        ...
                        <h3>Join a Team</h3>
                        <p style="margin-bottom: 2rem; color: #718096;">Find an existing squad and start contributing
                            immediately.</p>
                    </div>
                ...
                <div class="split-box">
                    <div>
                        <span class="icon-large">🚩</span>
                        <h3>Create a Team</h3>
                        <p style="margin-bottom: 2rem; color: #718096;">Be a leader! Start your own team and invite friends.
                        </p>
                    </div>
