...
<head>
    ...
    <style>
        ...
        .back-button:hover {
            ...
            box-shadow: 0 4px 12px rgba(45, 93, 63, 0.2);
        }
...
<body>
    ...
    <div class="container">
        <?php if ($has_team): ?>
            ...
            <div class="team-hero">
                <h1 style="margin-bottom: 0.5rem; color: white;"><?php echo htmlspecialchars($user_data['team_name']); ?>
                </h1>
                <p style="opacity: 0.9; font-size: 1.1rem; margin-bottom: 1.5rem; color: #E2E8F0;">
                    <?php echo htmlspecialchars($user_data['description']); ?></p>
                <div
                    style="background: rgba(255,255,255,0.2); display: inline-block; padding: 8px 16px; border-radius: 8px;">
                ...
                <?php while ($mem = $members->fetch_assoc()): ?>
                    <div class="member-item">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <div
                                style="width: 40px; height: 40px; background: #EDF2F7; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem;">
                                👤</div>
            ...
            <div style="margin-top: 2rem; text-align: center;">
                <button onclick="confirmLeaveTeam()"
                    style="background-color: #DC2626; color: white; border: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; cursor: pointer;">
                    Leave Team
                </button>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="split-container">
                <div class="split-box">
                    ...
                    <h3>Join a Team</h3>
                    <p style="color: #718096; margin-bottom: 1.5rem;">Browse and join existing teams competing in recycling
                        challenges.</p>
                    <a href="team_join.php" class="btn btn-primary" style="width: 100%; display: inline-block; text-decoration: none;">Browse
                        Teams</a>
                </div>
                ...
                <div class="split-box">
                    <span class="icon-large">🚩</span>
                    <h3>Create a Team</h3>
                    <p style="color: #718096; margin-bottom: 1.5rem;">Start your own team and invite others to join your
                        mission.</p>
                    <a href="team_create.php" class="btn btn-secondary" style="width: 100%; display: inline-block; text-decoration: none;">Create
                        New Team</a>
                </div>
            </div>
        <?php endif; ?>
