...
<div class="stats-row">
    <div class="stat-card">
        <h3><?php echo mysqli_num_rows($active_result);
        mysqli_data_seek($active_result, 0); ?></h3>
        <p>Active Challenges</p>
    </div>
    <div class="stat-card" style="background: linear-gradient(135deg, #3B82F6 0%, #60A5FA 100%);">
        <h3><?php echo mysqli_num_rows($upcoming_result);
        mysqli_data_seek($upcoming_result, 0); ?></h3>
        <p>Upcoming Challenges</p>
    </div>
    <div class="stat-card" style="background: linear-gradient(135deg, #F59E0B 0%, #FBBF24 100%);">
        <h3><?php echo mysqli_num_rows($past_result);
        mysqli_data_seek($past_result, 0); ?></h3>
        <p>Past Challenges</p>
    </div>
</div>
            ...
            <?php while ($challenge = mysqli_fetch_assoc($active_result)): ?>
                <div class="challenge-card">
                    ...
                    <div class="challenge-actions">
                        ...
                        <a href="?delete=<?php echo $challenge['challenge_id']; ?>" class="btn btn-delete"
