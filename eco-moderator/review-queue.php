...
$sql = "SELECT s.submission_id, s.image_url, s.ai_confidence, s.created_at, s.user_id,
        ...
        WHERE s.status = 'pending' AND s.ai_confidence < 0.80
...
<div class="page-header">
    ...
    <p class="page-description">Review submissions with AI confidence below 80%. Approve or reject with feedback.</p>
</div>
